...
$(document).on("click", ".btn-register", function (e) {
    let TourNumber = $("#TourName option:selected").val();
    let AdultNumber = $("#Adult").val(),
        ChildNumber = $("#Child").val();
    let AdultVal = AdultNumber * TourNumber;
    let ChildVal = ChildNumber * TourNumber / 2;
    let TotalVal = AdultVal + ChildVal;
    ...
    window.location.href = './B6-receipt.html';
});
